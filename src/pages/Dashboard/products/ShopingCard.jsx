...
const ShopingCard = ({ setShowCart, showCart }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-100 flex justify-end">
      <div className={`w-full max-w-lg`}>
        <div
          className={` bg-white w-full max-w-lg h-full flex flex-col shadow-2xl  duration-300 ease-in-out transition-all ${showCart ? "translate-x-0" : "translate-x-full"}`}
        >
          {/* Header */}
